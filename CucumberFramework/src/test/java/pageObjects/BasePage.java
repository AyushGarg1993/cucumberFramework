...
//		public WebDriver driver = getDriver();
		...
		// The below code is used to just return the date so that when ever we are taking screenshot we know for which date
		...
		public static void captureScreenshot() throws IOException, InterruptedException {
			//below code is to capture screenshot
			File srcFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			
			screenshotName = returnDateTimeStamp(".png");

			FileUtils.copyFile(srcFile, new File(System.getProperty("user.dir") + "//ExtendReport//imgs//" + screenshotName));
//			FileUtils.copyFile(srcFile, new File(System.getProperty("/Users/ayushmac/Desktop/Cucumber_Framework/CucumberFramework/ExtendReport/imgs" + screenshotName)));

			
			// the below code is to attch screenshot to extended reprot
		...
		//Below code will return the name of the sceenshot
		public static String returnScreenshotName() {
//			return (System.getProperty("/Users/ayushmac/Desktop/Cucumber_Framework/CucumberFramework/ExtendReport/imgs" + screenshotName)).toString();
			return (System.getProperty("user.dir") + "\\ExtendReport\\imgs\\" + screenshotName).toString();
